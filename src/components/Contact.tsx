...
export default function Contact({ isDarkMode }: { isDarkMode: boolean }) {
  ...
  return (
    <section className="desert-section hero-parallax-container" id="contact">
      ...
      <div
        className={`section-content contact-content about-content ${pulseActive ? 'contact--pulse' : ''}`}
        style={{
          display: 'flex',
      ...
      >
          ...
          >
            {[
              ...
              <a
                ...
                className="road-sign-link road-sign-link--mini"
                key={link.id}
              >
        ...
        >
          ...
          <p style={{ opacity: 0.6, fontSize: '0.8rem' }}>
            © 2026 Mohamed Ali BENBELGHITH · Tunisia
          </p>
        </footer>
      </div>
    </section>
